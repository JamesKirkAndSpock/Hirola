...
urlpatterns = [
    ...
    path(r'^change_activation_email', views.change_activation_email, name='change_activation_email'),
    path(r'^send_link_to_new_address', views.send_link_to_new_address,
