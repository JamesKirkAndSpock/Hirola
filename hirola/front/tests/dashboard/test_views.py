...
class DashboardTemplate(BaseTestCase):
    ...
    def test_order_data_get_request(self):
        ...
        self.assertContains(get_response, "<b>Purchase Date </b><span> {}</span>".format(order.date.strftime("%b. %d, %Y")))
    ...
    def test_order_data_post_request(self):
        ...
        self.assertContains(post_response, "<b>Purchase Date </b><span> {}</span>".format(order.date.strftime("%b. %d, %Y")))
