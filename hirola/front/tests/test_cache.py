...
class PhoneCategoryViewCacheTest(BaseTestCase):
    ...
    def test_edit_size_category_to_non_category(self):
        '''
        ...
        self.assertEqual(size.size_category, None)
        cache_after_edit = cache.get('sizes_{}'.format(self.iphone.pk))
        self.assertEqual(cache_after_edit, None)

    def test_edit_size_category_to_another_category(self):
        '''
        ...
        self.assertEqual(size.size_category, self.iphone)
    ...
    def test_edit_size_non_to_non_category(self):
        ...
        self.assertEqual(edited_size.size_category, None)
